...
<section class="bg-primary text-white text-center p-5">
    <div class="container">
        ...
        <a href="{{ route('usuarios.dashboard') }}" class="btn btn-light btn-lg">Ver Cursos</a>
    </div>
</section>
...
<section class="py-5">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <img src="/assets/img/img2.jpg" class="card-img-top" alt="Curso 1">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img src="/assets/img/img3.jpg" class="card-img-top" alt="Curso 2">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img src="/assets/img/img4.jpg" class="card-img-top" alt="Curso 3">
                    <div class="card-body">
